...
echo "  External: https://<your-domain>/hub/hub"
echo "  Internal API: http://proxy-public.jupyter.svc.cluster.local/hub/hub/api"
echo ""
echo "XNAT Plugin Configuration:"
echo "  JupyterHub host URL: https://<your-domain>/"
echo "  JupyterHub API URL: http://proxy-public.jupyter.svc.cluster.local/hub/hub/api"
echo "  Service Token: See 5-jupyterhub-values.yaml (xnat-service.apiToken)"
echo "  Note: SSL is automatically provisioned via cert-manager."
echo ""
