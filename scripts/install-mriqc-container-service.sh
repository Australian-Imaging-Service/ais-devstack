...
enable_wrapper_sitewide "${dcm2niix_id}" "dcm2niix-session"
...
enable_wrapper_for_projects "${dcm2niix_id}" "dcm2niix-session"
...
verify_wrapper_enabled "${dcm2niix_id}" "dcm2niix-session"
...
echo "Installed dcm2niix command id ${dcm2niix_id}; wrappers dcm2niix-scan and dcm2niix-session are enabled site-wide"
...
echo "Installed MuscleMap command id ${musclemap_id}; wrapper musclemap-dicom-scan is enabled site-wide"
echo "Installed Spinal Cord Toolbox command id ${sct_id}; wrapper spinalcordtoolbox-deepseg-dicom-scan is enabled site-wide"
